...
namespace ShopDongHo.Models.Entities
{
    public class ShopDbInitializer : DropCreateDatabaseIfModelChanges<ShopDbContext>
    {
        protected override void Seed(ShopDbContext context)
        {
            ...
            {
                new Category { Name = "Đồng hồ nam", Description = "Đồng hồ dành cho nam giới" },
                new Category { Name = "Đồng hồ nữ", Description = "Đồng hồ dành cho nữ giới" },
                new Category { Name = "Đồng hồ thể thao", Description = "Đồng hồ thể thao chống nước" },
                new Category { Name = "Đồng hồ thông minh", Description = "Smartwatch và đồng hồ thông minh" }
            };
